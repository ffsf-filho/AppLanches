...
public partial class MinhaContaPage : ContentPage
{
    ...
    private async void BtnSalvar_Clicked(object sender, EventArgs e)
    {
        ...
        await DisplayAlert("Informações Salvas", "Sua informações foram salvas com sucesso.", "OK");
    }
        ...
        if (errorMessage is not null)
        {
            switch (errorMessage)
            {
                case "Unauthorized":
                    ...
                    return imagemPadrao;
                default:
                    await DisplayAlert("Erro", errorMessage ?? "Não foi possível obeter a imagem.", "OK");
                    return imagemPadrao;
            }
        }
